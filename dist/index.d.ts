...
export declare const ContractFileView: ({ file, meta, referencePoint, selected, transform, appearance, }: ContractFileProps) => JSX_2.Element | null;

export declare type CoordinateSystemType = 'RIGHT_HANDED_X_UP' | 'LEFT_HANDED_X_UP' | 'RIGHT_HANDED_Y_UP' | 'LEFT_HANDED_Y_UP' | 'RIGHT_HANDED_Z_UP' | 'LEFT_HANDED_Z_UP';
