...
import { ContractFile as ContractFile_4 } from './api-2-legged';
...
declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ext: {
        ...
        putExtV2AuthenticatedContractFile: (contractFileId: string, data: {
             ...
             */
            status?: number;
        }, params?: RequestParams) => Promise<HttpResponse<ContractFile_3, any>>;
        /**
 ...
 * 契約項目ファイル
 */
declare interface ContractFile_3 {
    /** 契約項目ファイルID */
    id?: number;
    /** ファイル名 */
    name?: string;
...
export declare class RCDEClient {
    ...
    getContractFileProcessingStatus(params: {
        contractId: number;
        contractFileId: number;
    }): Promise<{
        status: string;
 ...
 */
export declare const ViewerHeader: FC<ViewerHeaderProps>;

export declare type ViewerHeaderProps = {
